                ...
                {weekDays.map((date, colIdx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {label && label.slotCount >= 4 && (
                          <div className="absolute inset-x-0.5 top-0 pointer-events-none z-10 truncate">
                            <span className="text-[9px] font-medium text-[#0090d9] leading-tight block">
