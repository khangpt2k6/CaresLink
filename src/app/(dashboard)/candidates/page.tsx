...
export default function CandidatesPage() {
  ...
  const inputClass =
    "rounded-md border border-[#e8e8e5] bg-white px-3 py-2 text-sm text-[#37352f] placeholder:text-[#b4b4b0] focus:border-[#00BFFF] focus:outline-none focus:ring-1 focus:ring-[#00BFFF]/20";
    ...
    <div className="p-8 max-w-5xl">
      ...
      <div className="card mt-6 mb-6 p-5">
        ...
        <form onSubmit={handleAdd} className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <button type="submit" disabled={adding} className="rounded-lg bg-[#00BFFF] px-4 py-2 text-sm font-medium text-white hover:bg-[#00A8E0] transition-colors disabled:opacity-40">
            {adding ? "Adding..." : "Add"}
          </button>
        </form>
      </div>
      ...
      {/* AI Response */}
      {aiPrompt && (
        <div className="card animate-in mb-5 border-l-2 border-l-[#00BFFF] p-4">
          <div className="flex items-start gap-3">
            <div className="rounded-md bg-[#e6faff] p-1.5">
