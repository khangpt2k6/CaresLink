...
import {
  Printer, Check, Briefcase, GraduationCap, Award,
  Wrench, MapPin, Phone, Mail, Loader2, ChevronRight,
} from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="flex h-screen overflow-hidden bg-[#f0f4f8]">
        {/* Sidebar */}
        <div className="no-print w-72 shrink-0 overflow-y-auto border-r border-[#e2e8f0] bg-white px-5 py-6">
          <div className="mb-5">
            <h1 className="text-base font-bold text-[#1a2b3c]">Resume Builder</h1>
            <p className="text-xs text-[#8a95a3]">Choose a template and print</p>
          </div>
